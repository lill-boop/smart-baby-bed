...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, relay_hot_Pin|relay_fan_Pin|alarm_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = relay_hot_Pin|relay_fan_Pin|alarm_Pin;
  ...
  /*Configure GPIO pins : PB10 PB11 PBPin PB8
                           PB9 */
  GPIO_InitStruct.Pin = GPIO_PIN_10|GPIO_PIN_11|lullabuy_Pin|GPIO_PIN_8
                          |GPIO_PIN_9;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
